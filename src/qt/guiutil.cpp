...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "paccoin.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for paccoin.lnk
...
{
    return GetAutostartDir() / "paccoin.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (!optionFile.good())
            return false;
        // Write a paccoin.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=paccoin\n";
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("paccoin-Qt") + " " + tr("version") + " " +
