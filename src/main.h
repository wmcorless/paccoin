...
#ifndef paccoin_MAIN_H
#define paccoin_MAIN_H
...
static const int64 MAX_MONEY = 100000000000000 * COIN;//100 Trillion
static const int64 MAX_MINT_PROOF_OF_WORK = 500 * COIN;	//500 Coins per block
static const int64 MAX_MINT_PROOF_OF_STAKE = 0.0005 * MAX_MINT_PROOF_OF_WORK;	//
...
public:
    ...
    */
    ...
    /** Amount of paccoins spent by this transaction.
    ...
    /** Amount of paccoins coming in to this transaction
...
public:
    ...
    {
        // Protocol switch to support p2pool at paccoin block #9689
        ...
        // Before paccoin block #9689 - old protocol
