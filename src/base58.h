 ...
 */
class CpaccoinAddress;
class CpaccoinAddressVisitor : public boost::static_visitor<bool>
{
private:
    CpaccoinAddress *addr;
public:
    CpaccoinAddressVisitor(CpaccoinAddress *addrIn) : addr(addrIn) { }
...
public:
    ...
    {
        return boost::apply_visitor(CpaccoinAddressVisitor(this), dest);
    }
    ...
    CpaccoinAddress(const CTxDestination &dest)
    {
        Set(dest);
    }
...
bool inline CpaccoinAddressVisitor::operator()(const CKeyID &id) const         { return addr->Set(id); }
bool inline CpaccoinAddressVisitor::operator()(const CScriptID &id) const      { return addr->Set(id); }
bool inline CpaccoinAddressVisitor::operator()(const CNoDestination &id) const { return false; }
